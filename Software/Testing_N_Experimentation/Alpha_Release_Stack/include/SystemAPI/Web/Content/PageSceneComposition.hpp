...
<body>
  ...
  <script>
    ...
    const ANIMATION_TYPES = [
      { id: 'static_image', name: 'Static Image', icon: '&#x25A0;', desc: 'Display saved sprite' },
      { id: 'gyro_eyes', name: 'Gyro Eyes', icon: '&#x25C9;', desc: 'Motion-reactive eyes' }
    ];

    const TRANSITION_TYPES = [
      { id: 'none', name: 'None', icon: '&#x2192;' },
      { id: 'sdf_morph', name: 'SDF Morph', icon: '&#x25C6;' },
    ...
    const ANIM_PARAMS = {
      static_image: [
        { section: 'Display', params: [
          { id: 'x_offset', name: 'X Offset', type: 'slider', min: -64, max: 64, step: 1, default: 0 },
          { id: 'y_offset', name: 'Y Offset', type: 'slider', min: -32, max: 32, step: 1, default: 0 }
        ]}
      ],
      gyro_eyes: [
        { section: 'Motion', params: [
          { id: 'gyro_sensitivity', name: 'Gyro Sensitivity', type: 'slider', min: 0.1, max: 3.0, step: 0.1, default: 1.0 },
          { id: 'movement_scale', name: 'Movement Range', type: 'slider', min: 2, max: 20, step: 1, default: 10 },
          { id: 'smoothing', name: 'Smoothing', type: 'slider', min: 1, max: 10, step: 1, default: 5 }
        ]},
        { section: 'Appearance', params: [
          { id: 'eye_radius', name: 'Eye Size', type: 'slider', min: 6, max: 16, step: 1, default: 12 },
          { id: 'eye_color', name: 'Eye Color', type: 'color', default: '#ffffff' },
          { id: 'bg_color', name: 'Background', type: 'color', default: '#000000' }
        ]}
      ]
    };
